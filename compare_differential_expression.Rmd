...
fig2 = plot_concordance_logFC( df, square=FALSE ) + ylab("logFC from  COS/NPC") + xlab("logFC from CommonMind") + ggtitle("COS/NPC vs CommonMind")    
...
fig4 = plot_concordance_logFC( df, square=FALSE ) + ylab("logFC from  COS/NPC") + xlab("logFC from HBCC") + ggtitle("COS/NPC vs HBCC")  
...
fig2 = plot_concordance_logFC( df, square=FALSE ) + ylab("logFC from  COS/Neuron") + xlab("logFC from CommonMind") + ggtitle("COS/Neuron vs CommonMind")    
...
fig4 = plot_concordance_logFC( df, square=FALSE ) + ylab("logFC from  COS/Neuron") + xlab("logFC from HBCC") + ggtitle("COS/Neuron vs HBCC")    
